...
function  mapList(){	
	...
	return new Promise((resolve, reject)=>{		
		...
		$.get(`/ride/mapList?page=${globalCurrentPage}&perPageNum=${dataPerPage}&searchType=${searchType}&keyword=${keyword}`, function(res){			
...
///B 유형
	...
	var content = `<div class="overlaybox" id="overlaybox-${place.bno}" onmouseover="overlayboxOver('${place.bno}')">
	       		 	<div class="boxtitle" onclick="kakaoGetDirections('${place.address}' , '${place.placeDong}')"  >
	       		 	 <span class="fc-y">도착지:</span>
	       		 	${place.placeDong}
	        ...
	        <ul>
	            <li class="up"  onclick="openNewWindow('${place.address}')"  >
		         ...
		         <li class="up" style="display:flex; justify-content: space-between;">
	            	...
	            	<span><i class="fas fa-hourglass-end"></i>  ${place.ridePricePeriod} ${comma(place.ridePrice)}원</span>                  
	            </li>
	            
	                 
	            
	             <li class="up" style="display:flex; justify-content: space-between;">
	            	<span><i class="fa fa-calendar"></i> : ${place.rideDay}</span> 
	            	<span><i class="fas fa-hourglass-end"></i> 출발시간 : ${place.rideTime}</span>             	          
	            </li>  
	            <li class="up" style="display:flex; justify-content: space-between;">
...
function openNewWindow(bno ,boardType){
	...
	openNewWindow.location.href = `/ride/together/read/`+bno;
}
...
function  kakaoGetDirections(startPoint , endPoint){
	var openNewWindow = window.open("about:blank");
	openNewWindow.location.href = "https://map.kakao.com/?sName="+startPoint+"&eName="+endPoint;
}
...
$(function(){
	...
	$("#makerInfoShow").on("click", function(e){	
	  	location.href="/ride/map?convertToggle=false";
	});
	
	
	$("#makerInfoShowAll").on("click", function(e){
		location.href="/ride/map?convertToggle=true";
	});
