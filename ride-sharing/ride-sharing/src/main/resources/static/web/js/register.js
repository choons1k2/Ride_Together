...
function phoneCertification() {
	...
	setTimeout(()=>{
            		...
            		document.getElementById("phone").setAttribute('readonly', 'ture');
            		document.getElementById("phoneValidation").innerText="전화번호 인증 완료";
            		document.getElementById("phoneValidation").style.color="rgb(76, 175, 80)";  
            		document.getElementById("phoneValidation").setAttribute("auth", true);  
            		document.getElementById("phoneCertification-btn").setAttribute('onclick', 'alert("인증처리 되었습니다.");'); 
            		document.getElementById("phoneCertification-btn").style.background="#9e9e9e";  
            		alert("인증 처리 되었습니다.");               
       },100);
