...
content = `<div class="overlaybox" id="overlaybox-${bno}" onmouseover="overlayboxOver('${bno}')">
        ...
        <ul>
            <li class="up"  onclick="openNewWindow('${address}')">
            <span><i class="fa fa-map-marker"></i> : ${address}</span>             
             ...
             <li class="up" style="display:flex; justify-content: space-between;">
            	...
            	<span><i class="fas fa-hourglass-end"></i>  ${jsonBoard.ridePricePeriod} ${comma(jsonBoard.ridePrice)}원</span>                  
            </li>
            
            
             <li class="up" style="display:flex; justify-content: space-between;">
            	<span><i class="fa fa-calendar"></i> ${jsonBoard.rideDay}</span> 
            	<span><i class="fas fa-hourglass-end"></i> 출발시간 : ${jsonBoard.rideTime}</span>             	          
            </li>  
            <li class="up" style="display:flex; justify-content: space-between;">
...
$(document).ready(function(){	
	...
	$('.board-edit-input').focusin(function() {
		$(this).css("border", "1px solid #f7d953");
	});
