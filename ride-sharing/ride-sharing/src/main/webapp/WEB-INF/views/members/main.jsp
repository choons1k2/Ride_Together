                        ...
                        <div class="mb-3" >
                          <div class="row">
                        	...
                        	<select name="boardType" class="form-control">
                        		...
                        		<option value="ride_together" ${param.boardType eq 'ride_together' ? 'selected' :''}>함께 타요</option>
                                ...
                                <table class="table table-bordered" id="dataTable" >
                                    ...
                                    <c:forEach items="${myBoardList}" var="row">
                                        <tr>
                                            ...
                                            <c:choose>
                                            	<c:when test="${row.boardType eq 'ride_together'}">
                                            		<span class="btn-primary p-1">함께 타요</span>
                                            	</c:when>
                                            ...
                                            <c:choose>
                                            	<c:when test="${row.boardType eq 'ride_together'}">
                                            		<a href="/ride/together/read/${row.bno}">${row.title}</a>
                                            	</c:when>
                                           ...
                                           <%--  	<input type="checkbox" 	name="bno" class="bno"	value="${row.bno}" >
                                            ...
                                            <c:choose>
                                            	<c:when test="${row.boardType eq 'ride_together'}">
	                                            	<form action="/ride/together/boardEditDirect" method="post"> 
