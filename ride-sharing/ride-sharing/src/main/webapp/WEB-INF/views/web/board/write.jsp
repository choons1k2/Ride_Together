	...
	<section id="warp">
		<div class="container board-container" >
			<div class="panel panel-warning" style="border: 1px solid #dadada;">
				<div class="panel-title box-subject" style="border-bottom: 1px solid #dadada;">게시판 등록하기</div>
					...
					<form name="form1" id="form1" action="/board/write" enctype="multipart/form-data" method="post">
						...
						<c:choose>
							<c:when test="${not empty USER}">
								<input class="button form-control tooltipstered wsubmit" type="submit" value="등록하기" style="color: #fff">	
							</c:when>
							<c:otherwise>
