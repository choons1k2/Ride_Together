...
<%@ include file="../include/header.jsp" %>
 ...
 <section id="warp">
 		...
 		<input type="hidden" id="board_url" value="/ride/together">
 		<input type="hidden" id="board_type" value="ride_together">
		...
		<textarea type="hidden" id="jsonBoard" >${jsonBoard}</textarea>
        ...
        <div class="container read-container" >
            		...
            		<li>            		
     			    ...
     			    <c:if test="${not empty USER and (USER.role eq 'ROLE_ADMIN') or (USER.role eq 'ROLE_MANAGER') }">
							<li style="margin-right: 10px">
								<a class="button right-board" href="/ride/together/write">등록하기</a>
							</li>	
					</c:if>           		            	            
            	</ul>
            ...
            <div class="sub_wrap">
            	 <p>
            		...
            		<span>
            			<span class="red" data-toggle="tooltip" title="출발지역">
            				<i class="fas fa-compass red" title="출발지역"  data-toggle="tooltip"></i>
            				출발:
            				<b style="color: #000;">${boardVO.startPlaceDong}</b> 
            			</span>
            		</span>
    
                	<span class="blue" data-toggle="tooltip" title="도착지역">
            				<i class="fas fa-compass blue" title="도착지역"  data-toggle="tooltip"></i> 
            				도착:
            				<b style="color: #000;">${boardVO.placeDong}</b>
            			</span>
            		</span>   
            		
            		
            		<span>
            			가격:  ${boardVO.ridePricePeriod}&nbsp;
						<fmt:formatNumber pattern="#,###" value="${boardVO.ridePrice}" />원	
            		</span>
            		     		
            		<span>
            			${boardVO.rideDay} (${boardVO.rideTime})	
            		</span>	     		
      			...
      			<form method="post" action="/ride/together/boardEditDirect"  id="directForm"> 
