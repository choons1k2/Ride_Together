...
<c:set var="URI" value="${pageContext.request.requestURI}" />
	...
	<div class="topTitle">
		<div>
		<span class="span"  onclick="location.href='/'">
			<img src="/resources/web/images/logo.png" >
		</span>
			<a href="/">
				<img src="/resources/web/images/car.png" class="car" >
			</a>
		</div>
	...
	<c:choose>
		...
		<c:otherwise>	
			...
			<li class="m-login"><a href="/members" class="nav-title nav-title-username" >${USER.username} 님</a>	
...
<nav class="container" id="nav" role="navigation" style=" ">
	<ul style="display: block;">
		...
		<li class="navli">
		  <a class="nav-title ${fn:contains(URL, 'introduction')? 'active':''}"  href="/ride/together/list"  >
		  <span>함께 타요</span></a>
		</li>
		...
		<li class="navli">
		  <a class="nav-title ${fn:contains(URL, 'map')? 'active':''} "  href="/ride/map" >함께 타요 맵</a>
		</li>					
		...
		<div class="visible-xs visible-sm"
			style="width: 100%; border-bottom: 1px solid #dadada; border-top: 1px solid #f7d953; background-color: white; position: absolute; z-index: 30000;">
...
<!-- 				<li class="mobilenav" style="background-color: #fff; color: #333 !important">
		...
		<li class="m-login">				  
		  <a href="/logout"  class="mobile-ml-10">로그아웃</a>
				...
				<li class="mobilenav">
				  <a class="${fn:contains(URL, 'introduction')? 'active':''}"  href="/ride/together/list"  >
				 	함께 타요
				 </a>
				</li>
				...
				<li class="mobilenav">
				  <a class="${fn:contains(URL, 'map')? 'active':''} "  href="/ride/map" >함께 타요 맵</a>
				</li>					
