...
import ride.sharing.model.dao.mapper.BoardMapper;
import ride.sharing.model.vo.BoardVO;
import ride.sharing.model.vo.DongVO;
...
public class BoardServiceImpl implements BoardService {
	...
	@Override
	public List<DongVO>  dongList() throws Exception{
		return boardMapper.dongList();
	}

	@Override
	public List<BoardVO> getMainRideList() throws Exception {
		return boardMapper.getMainRideList();
	}
}
